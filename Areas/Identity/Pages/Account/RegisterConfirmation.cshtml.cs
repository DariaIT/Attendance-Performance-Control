...
namespace Attendance_Performance_Control.Areas.Identity.Pages.Account
{
    ...
    public class RegisterConfirmationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string email, string returnUrl = null)
        {
            ...
            // This code is generating account confirmation link on "RegisterConfirmation" page for development propose
            //Comment this then start to use real email sender
